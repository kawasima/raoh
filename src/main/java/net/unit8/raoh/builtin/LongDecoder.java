...
public class LongDecoder<I> implements Decoder<I, Long> {
    ...
    public LongDecoder<I> positive() {
        return chain((value, path) -> {
            if (value <= 0) {
                return Result.fail(path, "out_of_range", "must be positive", Map.of("actual", value));
            }
            return Result.ok(value);
        });
    }
    ...
    public LongDecoder<I> negative() {
        return chain((value, path) -> {
            if (value >= 0) {
                return Result.fail(path, "out_of_range", "must be negative", Map.of("actual", value));
            }
            return Result.ok(value);
        });
    }
    ...
    public LongDecoder<I> nonNegative() {
        return chain((value, path) -> {
            if (value < 0) {
                return Result.fail(path, "out_of_range", "must be non-negative", Map.of("actual", value));
            }
            return Result.ok(value);
        });
    }
    ...
    public LongDecoder<I> nonPositive() {
        return chain((value, path) -> {
            if (value > 0) {
                return Result.fail(path, "out_of_range", "must be non-positive", Map.of("actual", value));
            }
            return Result.ok(value);
        });
    }
